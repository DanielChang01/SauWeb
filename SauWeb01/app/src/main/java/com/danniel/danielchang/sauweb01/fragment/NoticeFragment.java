...
public class NoticeFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/notice";
    public static String news_category = "/notice/";
    View view;
