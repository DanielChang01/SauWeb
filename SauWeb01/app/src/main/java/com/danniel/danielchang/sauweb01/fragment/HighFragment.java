...
public class HighFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/high";
    public static String news_category = "/high/";
    View view;
