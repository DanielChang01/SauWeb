...
public class FigureFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/figure";

    public static String news_category = "/figure/";
    View view;
