...
public class SchoolFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/school";
    public static String news_category = "/school/";
    View view;
