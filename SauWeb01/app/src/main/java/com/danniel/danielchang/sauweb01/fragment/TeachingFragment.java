...
public class TeachingFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/teaching";
    public static String news_category = "/teaching/";
    View view;
