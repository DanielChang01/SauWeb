...
public class LearningFragment extends Fragment implements LoadListView.ILoadListener{
    public static final String net_url = "http://news.sau.edu.cn/learning";
    public static String news_category = "/learning/";
    View view;
